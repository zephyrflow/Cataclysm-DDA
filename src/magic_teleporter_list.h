...
class teleporter_list
{
    ...
    public:
        ...
        // move translocator at omt_pos to omt_pos_new, will do nothing and return false if it does not exist.
        bool move_translocator( const tripoint_abs_omt &omt_pos, const tripoint_abs_omt &omt_pos_new );
